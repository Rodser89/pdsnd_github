...
MONTH_PARAMETER = ['all', 'january', 'february', 'march', 'april', 'may', 'june','july','august']
DAY_PARAMETER = ['all', 'monday', 'tuesday', 'wednesday', 'friday', 'saturday']
...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some US bikeshare data for future research!')
...
def main():
    while True:
        ...
        restart = input('\nWould you like to restart? Enter yes or no. If not have a nice day.\n')
